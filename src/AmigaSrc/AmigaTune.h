...
//
//		AmigaTune.h	-	Rewrite of Shock's MLIMBS.H file to use QuickTime MIDI rather than AIL.
//
//==============================================================================
...
//  PROTOTYPES
//-----------------
int AmigaTuneInit(void);
void AmigaTuneShutdown(void);
int AmigaTuneLoadTheme(char *theme, int themeID);
void AmigaTuneStartCurrentTheme(void);
void AmigaTuneKillCurrentTheme(void);
void AmigaTunePurgeCurrentTheme(void);
void AmigaTunePlayTune(int tune);
void AmigaTuneQueueTune(int tune);
void AmigaTunePrimeTimer(void);
void AmigaTuneUpdateVolume(void);
