...
//
//		AmigaTune.c	-	Rewrite of Shock's MLIMBS.C file to use QuickTime MIDI rather than AIL.
//
//==============================================================================
...
//------------------------------------------------------------------------------
//  Initializes the AmigaTune system.
//------------------------------------------------------------------------------
...
//  Stop the current tune playing, stop the tune queue timer task.
//------------------------------------------------------------------------------
void AmigaTunePurgeCurrentTheme() {
...
void AmigaTuneUpdateVolume(void) { UpdateVolumeXMI(); }
