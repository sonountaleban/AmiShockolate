...
The next release will have the full screen support implemented and hopefully the audio support, too. Then the following step should be the porting on the classic Amiga AGA in the near future.
